/** The io.github.edadma.datefns library provides utilities for working with dates in Scala.js projects.
  ...
  *
  *   - '''Date creation''': Functions to create Date objects (now, parseISO, fromUnixTime, createDate)
  ...
  * val christmas = createDate(2023, 11, 25) // December 25, 2023
  *
  ...
  * import io.github.edadma.datefns.*
  *
  * val date = createDate(2023, 11, 25, 14, 30)
  *
  * // Custom format
  ...
  * import io.github.edadma.datefns.*
  *
  * val date1 = createDate(2023, 0, 1)  // January 1, 2023
  * val date2 = createDate(2023, 11, 31) // December 31, 2023
  *
  ...
  * import io.github.edadma.datefns.*
  *
  * val date = createDate(2023, 11, 25)
  *
